#!/usr/bin/env python3
"""
Test trading functionality with minimal amount
"""
...
def test_minimal_trade():
    """Test trading with minimal amount"""
    print("🔍 Testing trade functionality with minimal amount...")
    ...
    try:
        ...
        print("This confirms the token has extremely low liquidity.")
        print("The bot will continue monitoring for new tokens with better liquidity.")
